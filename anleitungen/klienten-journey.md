...
1. **Akquise** — Klienten-Leads (`../nischen/autowerkstaetten/akquise/klienten-leads.csv`) via Kaltakquise (Anruf/vor Ort) oder eigene Ads. Ziel: Termin mit Entscheider (Inhaber).
...
4. **Willkommens-E-Mail** (`../nischen/autowerkstaetten/akquise/onboarding-email.md`) mit Instructions: Meta-Partner-Einladung, Asset-Upload (Drive: Logo, Fotos, Referenzen), Kalender verbinden.
