...
Alles wird eingebettet: Film, Bilder, Schriften. Die Datei liegt bewusst
ausserhalb des Deploy-Ordners, sie geht nie mit online. Zum Ausliefern zaehlt
allein webseiten/tagwerk/.
...
SEITE = os.path.join(HIER, '..', 'tagwerk')
ZIEL = os.path.join(HIER, 'vorschau-tagwerk.html')
